            ...
            <form id="formCrearDocente" onsubmit="crearDocente(event)">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <div style="display: flex; gap: 8px; align-items: center;">
                        <input type="password" id="passwordCrearDocente" name="password" required 
                               style="flex: 1; padding: 12px; border: 2px solid #e8ecef; border-radius: 8px; font-size: 1rem;">
                        <button type="button" onclick="togglePasswordVisibility('passwordCrearDocente', this)"
                        ...
                        <button type="button" onclick="generarPasswordTemporal('passwordCrearDocente')"
